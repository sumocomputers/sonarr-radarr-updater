#!/bin/zsh
#
# Builds "NZBGet-Sonarr-Radarr-Updater.app" from main.swift, bundles a
# copy of update-nzbget-sonarr-radarr.sh into it, and ad-hoc signs the
# result.

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${(%):-%x}")" && pwd)"
APP_NAME="NZBGet-Sonarr-Radarr-Updater"
...
cp "$SCRIPT_DIR/update-nzbget-sonarr-radarr.sh" "$DEST/Contents/Resources/update-nzbget-sonarr-radarr.sh"
chmod +x "$DEST/Contents/Resources/update-nzbget-sonarr-radarr.sh"
...
<dict>
	...
	<string>NZBGet-Sonarr-Radarr-Updater</string>
